...
export default defineConfig({
  plugins: [
    ...
    VitePWA({
      ...
      includeAssets: ['favicon.ico', 'icons/icon-180x180.png', 'icons/icon-152x152.png'],
      manifest: {
        name: 'Walmart DC 8980 Shipping Department',
        short_name: 'DC8980 Shipping',
        description: 'Door scheduling and pallet tracking system for Walmart DC 8980',
        theme_color: '#0071CE',
        background_color: '#0071CE',
        display: 'standalone',
