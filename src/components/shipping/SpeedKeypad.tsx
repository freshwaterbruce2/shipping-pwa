    ...
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      <DialogTrigger asChild>
        <Button
          ...
          className="gap-1 border-2 border-walmart-blue bg-walmart-blue/10 text-walmart-blue hover:bg-walmart-blue/20 transition-all duration-300 transform hover:scale-105 focus:scale-95 min-h-[44px] font-medium"
        >
