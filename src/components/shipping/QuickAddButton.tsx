      ...
      <Tooltip>
        <TooltipTrigger asChild>
          <Button
            ...
            size="sm"
            variant="outline"
            className="gap-1 border-2 border-walmart-yellow bg-walmart-yellow/80 text-walmart-blue-dark hover:bg-walmart-yellow/90 transition-all duration-300 transform hover:scale-105 focus:scale-95 min-h-[44px] font-medium shadow-md"
          >
            <Zap className="h-4 w-4 text-walmart-blue-dark" />
