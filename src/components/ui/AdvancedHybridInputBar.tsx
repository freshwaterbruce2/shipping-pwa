...
export const AdvancedHybridInputBar: React.FC<{
  ...
  }, [input, isListening, voiceActive, history, historyIndex, confidence]);

  // Submit logic
  const submitCommand = (text: string, conf?: number, isVoice?: boolean) => {
    if (!text.trim()) return;
