    ...
    <div className="pt-4 border-t mt-4">
            ...
            <div className="pl-6 space-y-4">
              <div>
                ...
                <Slider
                  ...
                  step={5}
                  onValueChange={(value) =>
                    handleSettingChange("voiceVolume", value[0] / 100)
                  }
                  className="w-full"
      ...
      >
        ...
        <Collapsible.Content className="overflow-hidden transition-all duration-300 ease-in-out">
          <div className={`mt-4 space-y-3 border-t pt-4 transform transition-transform duration-300 ease-in-out ${
            showAdvancedSettings ? "translate-y-0 opacity-100" : "-translate-y-2 opacity-0"
          }`}>
